...
When developing in UIKit, you can build something similar with playgrounds.
...
You can open a playground alongside a project with ~xed .~ (And probably with a xcworkspace as well?)
