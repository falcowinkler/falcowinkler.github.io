...
var file = cljs.core.get.call(null,map__25012__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25012__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25012__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25011){var _e = e25011;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___25014 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___25014)){
var seen_errors_25015 = temp__4655__auto___25014;
if(cljs.core.truth_(seen_errors_25015.has(self))){
} else {
seen_errors_25015.add(self);

var temp__4657__auto___25016 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___25016)){
var sense_25017 = temp__4657__auto___25016;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25017)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1547389516543
