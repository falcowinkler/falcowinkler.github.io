...
var o22687 = temp__4655__auto__;
var temp__4655__auto____$1 = (o22687["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o22688 = temp__4655__auto____$1;
return (o22688["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__21831__auto___22691 = t;
(o__21831__auto___22691["cljs$lang$ctorPrWriter"]).call(o__21831__auto___22691,t,writer);
}catch (e22690){var __22692 = e22690;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22693 = num_code;
switch (G__22693) {
case (1):
return (185);
...
}catch (e22695){var _e__21838__auto__ = e22695;
return false;
}})())){
...
var vec__22696 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22696,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o22699 = temp__4655__auto__;
var temp__4655__auto____$1 = (o22699["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o22700 = temp__4655__auto____$1;
return (o22700["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22703){
var vec__22704 = p__22703;
var ns_detector = cljs.core.nth.call(null,vec__22704,(0),null);
...
var G__22710 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22711 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22710;
remaining_tokens = G__22711;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22701){
var G__22702 = cljs.core.first.call(null,seq22701);
var seq22701__$1 = cljs.core.next.call(null,seq22701);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22702,seq22701__$1);
});
...
var vec__22715 = cljs.core.split_with.call(null,(function (p1__22714_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22714_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22715,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22715,(1),null);
...
var vec__22718 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22718,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22718,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22721 = cljs.core.rest.call(null,remaining_tokens);
var G__22722 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22721;
name_tokens = G__22722;
continue;
} else {
...
var vec__22725 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22725,(0),null);
var arity = cljs.core.nth.call(null,vec__22725,(1),null);
var vec__22728 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22728,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22728,(1),null);
var vec__22731 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22731,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22731,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22731,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22731,(3),null);
...
var vec__22737 = result;
var munged_ns = cljs.core.nth.call(null,vec__22737,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22737,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22737,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22737,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22737,(4),null);
var arity = cljs.core.nth.call(null,vec__22737,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__22741 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__22741,(0),null);
var args = cljs.core.nth.call(null,vec__22741,(1),null);
var vec__22744 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__22747 = (arity + (1));
var G__22748 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22749){
var vec__22750 = p__22749;
var arity = cljs.core.nth.call(null,vec__22750,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22750,(1),null);
...
return cljs.core.get.call(null,arities,p1__22753_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22754_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22757){
var vec__22758 = p__22757;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22758,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22755){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22766__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22766__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22766__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22766__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22767 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22767,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22767,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22767,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22767,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22767,(4),null);
var arity = cljs.core.nth.call(null,vec__22767,(5),null);
...
}catch (e22771){var _e__21838__auto__ = e22771;
...
var G__22772 = (obj[cljs.core.first.call(null,path)]);
var G__22773 = cljs.core.rest.call(null,path);
obj = G__22772;
path = G__22773;
continue;
} else {
...
return (function (accum,p__22774){
var vec__22775 = p__22774;
var bit = cljs.core.nth.call(null,vec__22775,(0),null);
var protocol = cljs.core.nth.call(null,vec__22775,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22778){
...
var selector = cljs.core.nth.call(null,vec__22779,(2),null);
...
var matches__$1 = cljs.core.nth.call(null,vec__22784,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22784,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22782_SHARP_){
return (obj[cljs.core.first.call(null,p1__22782_SHARP_)]);
});})(name,sorted_matches,vec__22784,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547389512081
