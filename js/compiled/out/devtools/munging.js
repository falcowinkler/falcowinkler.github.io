...
var o36722 = temp__4655__auto__;
var temp__4655__auto____$1 = (o36722["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o36723 = temp__4655__auto____$1;
return (o36723["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__21831__auto___36726 = t;
(o__21831__auto___36726["cljs$lang$ctorPrWriter"]).call(o__21831__auto___36726,t,writer);
}catch (e36725){var __36727 = e36725;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__36728 = num_code;
switch (G__36728) {
case (1):
return (185);
...
}catch (e36730){var _e__21838__auto__ = e36730;
return false;
}})())){
...
var vec__36731 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__36731,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o36734 = temp__4655__auto__;
var temp__4655__auto____$1 = (o36734["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o36735 = temp__4655__auto____$1;
return (o36735["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___36742 = arguments.length;
var i__4500__auto___36743 = (0);
while(true){
if((i__4500__auto___36743 < len__4499__auto___36742)){
args__4502__auto__.push((arguments[i__4500__auto___36743]));

var G__36744 = (i__4500__auto___36743 + (1));
i__4500__auto___36743 = G__36744;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__36738){
var vec__36739 = p__36738;
var ns_detector = cljs.core.nth.call(null,vec__36739,(0),null);
...
var G__36745 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__36746 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__36745;
remaining_tokens = G__36746;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq36736){
var G__36737 = cljs.core.first.call(null,seq36736);
var seq36736__$1 = cljs.core.next.call(null,seq36736);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36737,seq36736__$1);
});
...
var vec__36750 = cljs.core.split_with.call(null,(function (p1__36749_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36749_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__36750,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__36750,(1),null);
...
var vec__36753 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__36753,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__36753,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__36756 = cljs.core.rest.call(null,remaining_tokens);
var G__36757 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__36756;
name_tokens = G__36757;
continue;
} else {
...
var vec__36760 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__36760,(0),null);
var arity = cljs.core.nth.call(null,vec__36760,(1),null);
var vec__36763 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__36763,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__36763,(1),null);
var vec__36766 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__36766,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__36766,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__36766,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__36766,(3),null);
...
var vec__36772 = result;
var munged_ns = cljs.core.nth.call(null,vec__36772,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__36772,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__36772,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__36772,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__36772,(4),null);
var arity = cljs.core.nth.call(null,vec__36772,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__36776 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__36776,(0),null);
var args = cljs.core.nth.call(null,vec__36776,(1),null);
var vec__36779 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__36779,(0),null);
var name = cljs.core.nth.call(null,vec__36779,(1),null);
...
var G__36782 = (arity + (1));
var G__36783 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__36784){
var vec__36785 = p__36784;
var arity = cljs.core.nth.call(null,vec__36785,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__36785,(1),null);
...
return cljs.core.get.call(null,arities,p1__36788_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__36789_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___36796 = arguments.length;
var i__4500__auto___36797 = (0);
while(true){
if((i__4500__auto___36797 < len__4499__auto___36796)){
args__4502__auto__.push((arguments[i__4500__auto___36797]));

var G__36798 = (i__4500__auto___36797 + (1));
i__4500__auto___36797 = G__36798;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__36792){
var vec__36793 = p__36792;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__36793,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq36790){
var G__36791 = cljs.core.first.call(null,seq36790);
var seq36790__$1 = cljs.core.next.call(null,seq36790);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36791,seq36790__$1);
});
...
var G__36799 = arg;
var G__36799__$1 = (((G__36799 instanceof cljs.core.Keyword))?G__36799.fqn:null);
switch (G__36799__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__36801__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__36801__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__36801__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__36801__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__36802 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__36802,(0),null);
var fn_name = cljs.core.nth.call(null,vec__36802,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__36802,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__36802,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__36802,(4),null);
var arity = cljs.core.nth.call(null,vec__36802,(5),null);
...
}catch (e36806){var _e__21838__auto__ = e36806;
...
var G__36807 = (obj[cljs.core.first.call(null,path)]);
var G__36808 = cljs.core.rest.call(null,path);
obj = G__36807;
path = G__36808;
continue;
} else {
...
return (function (accum,p__36809){
var vec__36810 = p__36809;
var bit = cljs.core.nth.call(null,vec__36810,(0),null);
var protocol = cljs.core.nth.call(null,vec__36810,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__36813){
var vec__36814 = p__36813;
var ns = cljs.core.nth.call(null,vec__36814,(0),null);
var name = cljs.core.nth.call(null,vec__36814,(1),null);
var selector = cljs.core.nth.call(null,vec__36814,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__36819,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__36819,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__36819,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__36817_SHARP_){
return (obj[cljs.core.first.call(null,p1__36817_SHARP_)]);
});})(name,sorted_matches,vec__36819,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547392804356
