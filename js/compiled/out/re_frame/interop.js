...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__35724 = cljs.core.instance_QMARK_;
var expr__35725 = reactive_val;
if(cljs.core.truth_(pred__35724.call(null,reagent.ratom.RAtom,expr__35725))){
return "ra";
} else {
if(cljs.core.truth_(pred__35724.call(null,reagent.ratom.RCursor,expr__35725))){
return "rc";
} else {
if(cljs.core.truth_(pred__35724.call(null,reagent.ratom.Reaction,expr__35725))){
return "rx";
} else {
if(cljs.core.truth_(pred__35724.call(null,reagent.ratom.Track,expr__35725))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1547392802448
